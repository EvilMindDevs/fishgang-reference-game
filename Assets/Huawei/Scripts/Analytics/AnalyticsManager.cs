...
public class AnalyticsManager : MonoBehaviour
{
    ...
    public void SendEventWithBundle(String eventID, String key, String value)
    {
        ...
        Debug.Log($"[AnalyticsManager] : Analytics Kits Event Id:{eventID} Key:{key} Value:{value}");
    ...
    void Start()
    {
        Debug.Log($"[AnalyticsManager] : Analytics Kits start1");
        InitilizeAnalyticsInstane();
        Debug.Log($"[AnalyticsManager] : Analytics Kits start2");
    }
